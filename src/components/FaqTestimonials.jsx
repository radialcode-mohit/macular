...
const Faq = () => {
  ...
  return (
    <section className="py-xl-5 pb-5 mb-xl-5">
      <Container className="custom_container_1140 pb-5">
        <p
          data-aos="fade-down"
          className="text-center ff_plus fw_500 fs_4xl clr_white opacity_09"
        >
          Frequently Asked Questions
        </p>
        <Row className=" justify-content-center py-5">
          <Col data-aos="fade-up-right" lg={4}>
            <div>
          ...
          <Col data-aos="fade-up-left" lg={7} className="pt-4 pt-lg-0">
