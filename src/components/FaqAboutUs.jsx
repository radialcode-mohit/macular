...
const FaqAboutUs = () => {
  ...
  return (
    <section className="pb-5 bg_rgba_37_174_134 br_20">
      <Container className="pb-xl-5 pt-5 custom_container_1140">
        <p className="mb-0 pt-xl-5"></p>
        <p className="text-center ff_plus fw_500 fs_4xl clr_white opacity_09 position-relative faqarrow">
        ...
        <Row className=" justify-content-center py-5">
          ...
          <Col lg={7} className="pt-4 pt-lg-0 position-relative">
            <div className="about_us_faq_crcle_green position-absolute"> </div>
